...
```bash
docker build --platform linux/amd64 -t aliencoweatcake/amd64-jammy-qt6projects:qt6.11.1 .
docker build --platform linux/arm64 -t aliencoweatcake/arm64-jammy-qt6projects:qt6.11.1 .
```
